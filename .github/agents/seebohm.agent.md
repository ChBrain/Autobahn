...
**Canonical source:** [ministry/personas/persona_seebohm.md](../../ministry/personas/persona_seebohm.md)

For character identity, background, action, and shadow, refer to the persona file above. This agent configuration specifies operational constraints and governance workflow only.

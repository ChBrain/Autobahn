...
## Shown
Exit 9. The sign: Itzehoe-Mitte. The road here crossing the Störbrücke section - the bridge over the Stör river. Two lanes in each direction. The road is motorway standard here despite what the gap in the original numbering implied. Itzehoe visible to the east.

## Holds
[km 90.3](piece_the_kilometerstein.md): Itzehoe-Mitte.
- 2.8 km north: [Itzehoe-Nord](place_a23_08_itzehoe_nord.md)
- 5.3 km south: [Itzehoe-Süd](place_a23_10_itzehoe_sued.md)

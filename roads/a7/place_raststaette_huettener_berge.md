...
## Shown
Between [Owschlag](place_a7_07_owschlag.md) and [Rendsburg/B�delsdorf](place_a7_08_rendsburg_buedelsdorf.md). No exit number. The pull-in from the right lane. Parking area: trucks left, cars right. The building: petrol station, shop, toilets, coffee counter. [The Rastst�tte Worker](position_raststaette_worker.md) behind the counter. The Autobahn audible from the parking area - the traffic continuing without the stopped cars.
...
* 2.7 km south on [the A7](place_a7.md) to [Rendsburg/B�delsdorf](place_a7_08_rendsburg_buedelsdorf.md).
* [The coffee](piece_the_coffee.md).
* [The tank](piece_the_tank.md).

## Offers
The stop. Coffee. Fuel. The first Rastst�tte southbound for drivers from Flensburg. The four minutes of not moving the body has been requesting since the border.

...
## Shown
The Bergedorf exit. The sign: Hamburg-Bergedorf. The Geest edge beginning to rise to the north. Bergedorf: Hamburg's easternmost district, historically a separate town with its own castle and market. The A25 passes it without entering it.

## Holds

* [km 9.6](piece_the_kilometerstein.md) on [the A25](place_a25.md).
* 2.0 km west on [the A25](place_a25.md) to [Hamburg-Nettelnburg](place_a25_4_hamburg_nettelnburg.md).
* 2.3 km east on [the A25](place_a25.md) to [Hamburg-Curslack](place_a25_6_hamburg_curslack.md).

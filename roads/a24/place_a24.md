...
## Withheld
The DDR infrastructure choice: built by the socialist state, financed by West Germany as part of transit agreements. The pre-war bridges replaced - Reichsautobahn surface beneath, Nazi engineering rebuilt for a different regime and then another. The lakes themselves - within kilometres, not visible from the motorway. The landscape's flatness absolute - no hills, no mountains, only water and sky and the horizon.

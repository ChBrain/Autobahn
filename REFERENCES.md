...
The Autobahn network data is drawn from publicly available infrastructure sources only.
...
**German Wikipedia** - Individual article for each motorway, each exit, and each named infrastructure element (bridges, tunnels, junctions). Used for historical context, geographic relationships, and withheld information in place files.
...
*v0.2.0 - KAI Worlds - Kai Schlueter - April 2026*
